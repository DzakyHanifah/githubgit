...
#clickHandler:hover ~ #button .caution #caution-left {
  ...
  -webkit-animation: glow_010 1.2s infinite;
...
@-webkit-keyframes shadow-launch {
  0% {
    opacity: 1;
  }
...
@-webkit-keyframes tag-transition {
  0%, 100% {
    opacity: 0;
  }
...
<div id="card2" class="container noselect">
