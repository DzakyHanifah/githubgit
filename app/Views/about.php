...
<head>
  ...
  height: 100vh;
  margin: 0;
  background-color: #f5f5f5; /* Tambahkan warna latar belakang untuk estetika */
}
...
.brutal-subscribe__container {
  ...
  position: relative;
  overflow: hidden;
  -webkit-box-shadow: 15px 15px 0 rgba(0, 0, 0, 0.605);
...
.brutal-subscribe__container:hover {
  ...
  -webkit-box-shadow: 20px 20px 0 rgba(0, 0, 0, 0.2);
  box-shadow: 20px 20px 0 rgba(0, 0, 0, 0.2);
  cursor: crosshair; /*cursor menjadi tanda + */
}
...
.brutal-subscribe__header::before {
  ...
  opacity: 0.1;
  -webkit-animation: stripe-animation 20s linear infinite;
...
.brutal-subscribe__container:hover .brutal-subscribe__title {
  -webkit-animation: glitch 0.3s infinite;
...
<body>
<!-- ONE -->
<button id="showCard1Btn" class="bbutton">Button</button>

<!-- TWO -->
<div id="card1" class="brutal-subscribe">
  <div class="brutal-subscribe__container">
    <div class="brutal-subscribe__header">
      <span class="brutal-subscribe__title">DZAKY HANIFAH</span>
      <span class="brutal-subscribe__subtitle"
        >Software developer</span>
      <span class="brutal-subscribe__subtitle"
        >Dz4kyhanifah@gmail.com</span>
      <span class="brutal-subscribe__subtitle"
        >Palembang 22 02 2222</span>
    </div>
    <form class="brutal-subscribe__form">
      
       
<div class="card">
  <a href="https://www.instagram.com/dz4ky_hanif/" target="_blank" class="socialContainer containerOne">
  ...
  <a href="https://x.com/Dzaky_hanifah" target="_blank" class="socialContainer containerTwo">
  ...
  <a href="https://www.linkedin.com/in/dzaky-hanifah-ahmad-30956a270/" target="_blank" class="socialContainer containerThree">
  ...
  <a href="https://wa.me/6285268668045" target="_blank" class="socialContainer containerFour">
    <svg class="socialSvg whatsappSvg" viewBox="0 0 16 16">
      ...
      <button id="closePageBtn" onclick="window.location.href='http://localhost:8080/last;';" class="brutal-subscribe__button">EXIT</button>
    
    </form>
    <div class="brutal-subscribe__decor">ORDER NOW!</div>
  </div>
</div>
...
<script>
        ...
        // Menampilkan Card 1 dan menyembunyikan tombol awal
